    ...
    return (
        <div className='body'>
            <div className="wrap animate pop">
                <div className="overlay">
                    <div className="overlay-content animate slide-left delay-2">
                        <h3 className="animate slide-left pop delay-4">Hội Lim</h3>
                    </div>
                    <div className="image-content-mot animate slide delay-5"></div>
            ...
            <div className="wrap animate pop">
                <div className="overlay">
                    <div className="overlay-content animate slide-left delay-2">
                        <h3 className="animate slide-left pop delay-4">Lễ hội Đền Bà Chúa Kho</h3>
                    </div>
                    <div className="image-content-hai animate slide delay-5"></div>
                    <div className="dots animate">
                        <div className="dot animate slide-up delay-6"></div>
                        <div className="dot animate slide-up delay-7"></div>
                        <div className="dot animate slide-up delay-8"></div>
